                ...
                <div class="swiper-slide">
                    <div class="row align-items-center hero-row">
                        ...
                        <div class="col-lg-6 col-md-5 col-12 hero-img-col text-center">
                            <img src="{{ asset(getImage($slide->image) ?? 'site/img/bannerBG.png') }}" alt="" class="img-fluid rounded-4 main-image">
                        </div>

                        <div class="col-lg-4 col-md-6 col-12 content-section">
                            <div class="content-wrapper">
                                <div class="logo-container mb-4 d-none d-lg-block">
                                    <img src="{{ asset(getImage($settings->getItem('logo')) ?? site_path('img/logo.png')) }}" alt="" class="logo-img">
                                </div>
