    ...
    <div class="table bg-white border-main">
        <div class="info  m-md-4">
            ...
            <div class="numbers row py-2" dir="rtl">
                <div class="numerOfdonamtion col-md-5 col-12 me-1 bg-main rounded-3 text-center bg-success">
                ...
                <div class="totalAmount col-md-5 col-12 mt-3 mt-md-0 bg-main rounded-3 text-center bg-success">
