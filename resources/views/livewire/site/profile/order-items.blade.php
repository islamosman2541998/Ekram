                                    ...
                                    <td> 
                                        @if(@$giftCard->giver_name)
                                            @if(@$showGift[$details->id] == 0 ) 
                                                <i wire:click="showGiftCart({{ $details->id }})" class='fa fa-plus bx-tada bx-flip-horizontal fs-5 text-info'></i>
                                            @elseif(@$showGift[$details->id] == 1 )
                                                <i wire:click="showGiftCart({{ $details->id }})" class='fa fa-minus-circle fs-5'></i>
                                            @endif
                                        @endif
                                    </td>
                                </tr>
