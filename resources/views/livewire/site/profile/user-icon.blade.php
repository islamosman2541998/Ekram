<div class="user-items">
    @if ($user == null)
        ...
        <div class="usertext px-2" onclick="window.location.href='{{ route('site.login') }}';">
            <a class="me-4" style="cursor: pointer;">@lang('Login')</a>
        </div>
@else
<div class="usericon p-1"
                class="dropdown-toggle " id="login" role="button" data-bs-toggle="dropdown" aria-expanded="false">
