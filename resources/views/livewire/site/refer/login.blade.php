<div>
    <form wire:submit.prevent="login" class="" id="login-form">
        ...
        <div class="input-group position-relative">
            <input type="password" wire:model="password" class="form-control" id="manager-password" required style="padding-left: 2.5rem;" />
