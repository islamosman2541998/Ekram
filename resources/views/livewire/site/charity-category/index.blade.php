                ...
                @forelse ($categoriesCarousels as $carouselIndex => $carousel)
                    @forelse ($carousel as $key => $category)
                        <div class="swiper-slide">
                            <a href="{{ route('site.projectCategories.show', @$category['trans'][0]['slug']) }}" class="text-decoration-none">
                                <div class="program-card h-100">
                                    <div class="program-card-img">
                                        @if ($category['background_image'])
                                            <img src="{{ asset(getImage($category['background_image'])) }}" class="img-fluid" alt="{{ @$category['trans'][0]['title'] }}">
                                        @endif
                                    </div>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 position-relative">
        ...
        <!-- الخط الواصل بين الدواير (يظهر في الشاشات الكبيرة فقط) -->
