<div id="payment-methods">
    ...
    <div class="TotalCard">
        ...
        @else
            ...
            @livewire('site.external.payments.visa', ['project' => $project, 'amount' => $amount, 'donationtype' => $donationtype, 'refer' => $refer])
            <!-- apple-pay-tab -->
            @elseif($paymentMethod == "applePay" && $applePayStatus)
            @livewire('site.external.payments.apple-pay', ['project' => $project, 'amount' => $amount, 'donationtype' => $donationtype, 'refer' => $refer])
            <!-- transfer-pay-tab -->
            @elseif($paymentMethod == "bankTransfer" && $banktransferStatus)
            @livewire('site.external.payments.bank-transfer', ['project' => $project, 'amount' => $amount, 'donationtype' => $donationtype, 'refer' => $refer])
            @endif
