...
<div class="card">
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-12 col-form-label">
                                                {{ trans('admin.title_in') }} {{ trans('locales.' . $locale) }}
                                        ...
                                        <div class="mb-3 row slug-section">
                                            <label class="col-sm-12 col-form-label">{{ trans('admin.slug_in') . trans('locales.' . $locale) }}
                                            </label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="mt-3 row">
                                            <label class="col-sm-12 col-form-label">
                                                {{ trans('admin.description_in') . trans('locales.' . $locale) }}
                                            </label>
                        ...
                        <div class="mt-4 mb-4 accordion" id="accordionExampleMeta">
                            <div class="border rounded accordion-item">
                                ...
                                <div id="collapseMeta{{ $key }}" class="mt-3 accordion-collapse collapse" aria-labelledby="headingMeta{{ $key }}" data-bs-parent="#accordionExampleMeta">
                                    <div class="accordion-body">
                                        @foreach (['en', 'ar'] as $key => $locale)
                                        {{-- meta_title_ ------------------------------------------------------------------------------------- --}}
                                        <div class="mb-3 row">
                                            <label class="col-sm-2 col-form-label">
                                                {{ trans('admin.meta_title_in') . trans('locales.' . $locale) }}</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-2 col-form-label">
                                                {{ trans('admin.meta_description_in') . trans('locales.' . $locale) }}
                                            </label>
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-2 col-form-label">
                                                {{ trans('admin.meta_key_in') . trans('locales.' . $locale) }}
                                            </label>
                                            <div class="mb-2 col-sm-10">
                                ...
                                <div id="collapseSetting" class="accordion-collapse collapse show" aria-labelledby="headingSetting" data-bs-parent="#accordionExampleSetting">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3 row title-section">
                                            ...
                                            <div class="col-sm-12">
                                                <select class="form-select form-select-sm select2 {{ empty($errors->first('categories')) ?: 'has-error' }}" required multiple name="categories[]">
                                ...
                                <div id="settings_post" class="accordion-collapse collapse " aria-labelledby="headingPublish" data-bs-parent="#accordionExamplePublish">
                                    <div class="accordion-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-3 row">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="statistic_status" name="statistic_status" {{ old('statistic_status', true) ? 'checked' : '' }}>
                                                        <label class="form-check-label" for="statistic_status">إظهار
                                                            الإحصائيات على الموقع</label>
                                                        @if ($errors->has('statistic_status'))
                                                        <span class="missiong-spam">{{ $errors->first('statistic_status') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <label for="visits_count" class="col-sm-12 col-form-label">عدد
                                                    الزيارات</label>
                                                <div class="col-sm-12">
                                                    <input type="number" name="visits_count" id="visits_count" value="{{ old('visits_count', 0) }}" class="form-control" min="0" />
                                                    @if ($errors->has('visits_count'))
                                                    <span class="missiong-spam">{{ $errors->first('visits_count') }}</span>
                                                    @endif
                                                </div>
                                            </div>

                                            <div class="col-sm-12">
                                                <label for="donations_count" class="col-sm-12 col-form-label">عدد
                                                    التبرعات</label>
                                                <div class="col-sm-12">
                                                    <input type="number" name="donations_count" id="donations_count" value="{{ old('donations_count', 0) }}" class="form-control" min="0" />
                                                    @if ($errors->has('donations_count'))
                                                    <span class="missiong-spam">{{ $errors->first('donations_count') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="mb-3 row">
                                                    <label for="last_donation_at" class="col-sm-12 col-form-label">آخر
                                                        عملية تبرع</label>
                                                    <div class="col-sm-12">
                                                        <input type="datetime-local" name="last_donation_at" id="last_donation_at" value="{{ old('last_donation_at') }}" class="form-control" />
                                                        @if ($errors->has('last_donation_at'))
                                                        <span class="missiong-spam">{{ $errors->first('last_donation_at') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            ...
                                            <div class="m-auto row ">
                                                ...
                                                <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="form-check form-switch form-check-success">
                                                        <input class="form-check-input {{ empty($errors->first('fast_donation')) ?: 'has-error' }}" type="checkbox" role="switch" name="fast_donation" {{ old('fast_donation') == 'on' ? 'checked' : '' }} id="flexSwitchCheckSuccessfast_donation">
                                                ...
                                                {{-- <div class="col-sm-6 mt-3">
                                                    ...
                                                    <div class="form-check form-switch form-check-success">
                                                        <input class="form-check-input {{ empty($errors->first('cashier_system')) ?: 'has-error' }}" type="checkbox" role="switch" name="cashier_system" {{ old('cashier_system') == 'on' ? 'checked' : '' }} id="flexSwitchCheckCashierSystem">
                                                        @if ($errors->has('cashier_system'))
                                                        <span class="missiong-spam">{{ $errors->first('cashier_system') }}</span>
                                                        @endif
                                                    </div>
                                                </div> --}}
                                            </div>
                                    ...
                                    <div id="payment_method" class="accordion-collapse collapse show" aria-labelledby="headingPayments" data-bs-parent="#accordionExamplePayments">
                                        <div class="accordion-body">
                                            ...
                                            <div class="mb-3 row title-section">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-select form-select-sm" name="donation_type" id="denation-type" required>
                                                        <option value="" selected disabled> @lang('charityProject.donation_type')
                                                        </option>
                                            ...
                                            @foreach ($languages as $key => $locale)
                                            <div class="mb-3 row">
                                                <label class="col-sm-12 col-form-label">{{ trans('charityProject.unit_price_in') . trans('locales.' . $locale) }}</label>
                                                <div class="col-sm-12">
                            ...
                            <div class="mt-4 mb-4 accordion" id="accordionExampleImages">
                                <div class="border rounded accordion-item">
                                    ...
                                    <div id="images_project" class="accordion-collapse collapse" aria-labelledby="headingImages" data-bs-parent="#accordionExampleImages">
                                        <div class="accordion-body">
                                            {{-- <div class="row">
                                                @livewire('files.upload-modal', ['model' => 'charity_projects', 'model_id' => null])
                                            </div> --}}
                                            {{-- cover image    ------------------------------------------------------------------------------------- --}}
                                            <div class="col-12">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control {{ empty($errors->first('cover_image')) ?: 'has-error' }}" type="file" accept="image/*" placeholder="@lang('admin.cover_image')" id="example-cover_image-input" name="cover_image" value="{{ old('cover_image') }}">
                                            ...
                                            {{-- <div class="col-12">
                                                    <div class="mb-3 row">
                                                        <label for="example-background_image-input"
                                                            class="col-sm-12 col-form-label">
                                                            @lang('charityProject.background_image') </label>
                                                        <div class="col-sm-12">
                                                            <input
                                                                class="form-control {{ empty($errors->first('background_image')) ?: 'has-error' }}"
                                            type="file" placeholder="@lang('admin.background_image')"
                                            id="example-background_image-input"
    ...
    <div class="row mb-3 text-end">
        <div>
            <a href="{{ route('admin.charity.projects.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm" id="chiledBack">@lang('button.cancel')</a>
