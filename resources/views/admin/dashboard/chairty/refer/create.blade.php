...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.charity.refers.store') }}" method="post" enctype="multipart/form-data"
                id="form-submit">
                @csrf
                                                                ...
                                                                <li class="py-1">
                                                                    <label class="mb-0 d-flex align-items-center gap-2">
                                                                        ...
                                                                        @if (!empty($manager->is_group_manager) && $manager->is_group_manager)
                                                                            <span
                                                                                class="badge bg-secondary ms-2">مشرف</span>
                                                                        @endif
                                                                    </label>
                                                                </li>
                                                            @empty
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control @error('job') is-invalid @enderror"
                                                        type="text" name="job" value="{{ old('job') }}">
                                                    @error('job')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="col-sm-10">
                                                    <input
                                                        class="form-control phone @error('whatsapp') is-invalid @enderror"
                                                        type="tel" name="whatsapp" value="{{ old('whatsapp') }}">
                                                    @error('whatsapp')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                        ...
                                                        <div class="col-6 col-md-4">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="children[]" id="child_{{ $other->id }}"
                                                                    value="{{ $other->id }}"
