            ...
            <form action="{{ route('admin.pages.index') }}" method="get">
                <div class="row">
                    ...
                    <div class="search-input col-md-2">
                        <button class="btn btn-primary btn-sm" type="submit" data-hover="{{ trans('button.search') }}"><i
                                class="bx bx-search-alt"> </i></button>
                        <a class="btn btn-success btn-sm" href="{{ route('admin.pages.index') }}"
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="main-datatable"
                        class="table table-bordered text-center table-striped table-table-success table-hover"
                        ...
                        <tbody>
                            @forelse($items as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ getImage($item->image) }}" target="_blank"> <img
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <a href="{{ route('admin.pages.show', $item->id) }}"
                                                ...
                                                data-hover="{{ trans('button.show') }}"><i class="bx bxs-show"></i></a>
                                            ...
                                            <button type="button" class="btn btn-neutral text-danger"
                                                data-bs-toggle="modal" data-bs-target="#deletePageModal{{ $item->id }}"
                ...
                @foreach ($items as $item)
                    <div class="modal fade" id="deletePageModal{{ $item->id }}" tabindex="-1"
                        aria-labelledby="deletePageModalLabel{{ $item->id }}" aria-hidden="true">

                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">

                                <div class="modal-header">
                                    <h5 class="modal-title" id="deletePageModalLabel{{ $item->id }}">
                                        تأكيد حذف الصفحة
                                    </h5>
